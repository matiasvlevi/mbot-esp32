...
const adaptiveFontSize = (len: number) => {
  if (len < 10) return 28;
  else if (len >= 10 && len < 20) return 24;
  else if (len >= 20 && len < 32) return 22;
  else if (len >= 32 && len < 120) return 18;
  else if (len >= 120 && len < 240) return 16;
  else if (len >= 240 && len < 360) return 14;
  else if (len >= 360 && len < 1024) return 12;
  else return 10;
};
