...
export declare function exec(blueprints: Record<string, VisualNode>, nodes: Record<string, TNode>, edges: Record<string, TEdge>, dispatchEdge: Dispatch<EdgeAction>, dispatchNode: Dispatch<NodeAction>, store: Record<string, any>, eventStore: Record<string, any>, setStoreItem: Dispatch<StoreAction>, setEventStoreItem: Dispatch<EventStoreAction>, abortController: AbortController): Promise<boolean>;
