...
exports.exec = exports.execTriggeredNodes = exports.fetchNode = void 0;
function fetchNode(blueprints, nodes, edges, port) {
...
function execTriggeredNodes(blueprints, nodes, edges, startNode, dispatchNode) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
...
;
function exec(blueprints, nodes, edges, dispatchNode) {
    return __awaiter(this, void 0, void 0, function () {
        var BeginNode;
