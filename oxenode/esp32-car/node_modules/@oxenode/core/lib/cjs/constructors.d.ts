 ...
 * @returns
 */
export declare const constructPort: (port: VisualPort, i: number) => TPort;
/**
 ...
 * @returns
 */
export declare function constructNode(node: VisualNode, x?: number, y?: number, id?: undefined): TNode;
