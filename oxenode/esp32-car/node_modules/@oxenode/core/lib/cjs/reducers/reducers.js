...
exports.eventStoreReducer = exports.storeReducer = exports.edgeReducer = exports.nodesReducer = void 0;
...
const eventStoreReducer = (eventStore, action) => {
    switch (action.type) {
        case "SET": {
            return { ...action.value };
        }
...
exports.eventStoreReducer = eventStoreReducer;
